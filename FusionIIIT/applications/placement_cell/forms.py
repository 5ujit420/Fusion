...
class PlacementRecordSaveForm(forms.Form):
    ...
    ctc = forms.DecimalField(required=False, min_value=0)
    year = forms.IntegerField(required=False)
    test_type = forms.CharField(max_length=30, required=False)
    test_score = forms.IntegerField(required=False)


class ChairmanVisitSaveForm(forms.Form):
...
AddPlacementSchedule = AddSchedule
