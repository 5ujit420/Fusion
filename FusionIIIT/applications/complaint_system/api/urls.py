...
urlpatterns = [
    ...
    url(
        r"^removeservice_provider/(?P<s_id>[0-9]+)",
        views.edit_service_provider_api,
        name="service_provider-delete-api",
    ),
    url(
        r"^updateservice_provider/(?P<s_id>[0-9]+)",
        views.edit_service_provider_api,
        name="service_provider-put-api",
    ),
]
