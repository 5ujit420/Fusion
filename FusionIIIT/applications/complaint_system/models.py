...
class Caretaker(models.Model):
    ...
    area = models.CharField(choices=AreaChoices.choices, max_length=50, default=AreaChoices.HALL_3)
...
class Warden(models.Model):
    staff_id = models.ForeignKey(ExtraInfo, on_delete=models.CASCADE)
    area = models.CharField(choices=AreaChoices.choices, max_length=50, default=AreaChoices.HALL_1)
    rating = models.IntegerField(default=0)
...
class SectionIncharge(models.Model):
    staff_id = models.ForeignKey(ExtraInfo, on_delete=models.CASCADE)
    work_type = models.CharField(choices=ComplaintTypeChoices.choices, max_length=20, default=ComplaintTypeChoices.ELECTRICITY)
...
class Workers(models.Model):
    ...
    worker_type = models.CharField(choices=ComplaintTypeChoices.choices, max_length=20, default=ComplaintTypeChoices.INTERNET)
...
class StudentComplain(models.Model):
    ...
    complaint_type = models.CharField(choices=ComplaintTypeChoices.choices, max_length=20, default=ComplaintTypeChoices.INTERNET)
    location = models.CharField(max_length=50, choices=AreaChoices.choices)
...
class ServiceRoleBase(models.Model):
    type = models.CharField(choices=ComplaintTypeChoices.choices, max_length=30, default=ComplaintTypeChoices.ELECTRICITY)
...
class ServiceProvider(ServiceRoleBase):
...
class ServiceAuthority(ServiceRoleBase):
    ser_pro_id = models.ForeignKey(
        ExtraInfo,
        on_delete=models.CASCADE,
